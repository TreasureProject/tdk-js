...
export const ConnectMethodSelectionView = ({
  ...
  return (
    <div className="tdk-bg-night tdk-p-8 tdk-text-silver-100 tdk-font-sans tdk-space-y-6">
      ...
      <div className="tdk-grid tdk-gap-2 tdk-grid-cols-2 md:tdk-grid-cols-5">
        <ConnectMethodButton
          title={t("connect.option.google")}
          onClick={() => onConnect("google")}
          disabled={isLoading}
        >
          <GoogleIcon className="tdk-w-6 tdk-h-6" />
        </ConnectMethodButton>
        <ConnectMethodButton
        ...
        {!disablePasskey ? (
          <ConnectMethodButton
            className="tdk-flex tdk-items-center tdk-gap-1 tdk-justify-center tdk-py-2 tdk-col-span-2 md:tdk-col-span-5"
